...
def ASYNCHRONOUS(datos):
    ...
    for g in G_index:
        for o in O_index[:-1]:
            MODEL.addConstr(1000*(1 - uego.sum('*', g, o)) >= gp.quicksum(gammago[g, o_prima] for o_prima in O_index if o_prima < o))
    
    for g in G_index:
        for o in O_index[:-1]:
            MODEL.addConstr(1000*(1 - vego.sum('*', g, o)) >= gp.quicksum(gammago[g, o_prima] for o_prima in O_index if o_prima >= o))
    ...
    if log:
        ...
        for g in grafos:
            nx.draw(g.G, g.pos, node_size=90, width = 2, 
                    node_color = 'blue', alpha = 1, edge_color = 'blue')
        
        
        # Mothership Route
    
        ax.arrow(datos.orig[0], datos.orig[1], xLo[1, 0].X-datos.orig[0], xLo[1, 1].X - datos.orig[1], width = 0.1, head_width = 0.5, length_includes_head = True, color = 'black')
        ax.scatter(datos.orig[0], datos.orig[1], s = 10, c = 'black')
        ...
        for o in O_index[1:]:
            ...
            if wasU and isU:
                ...
                ax.arrow(xLo[o-1, 0].X, xLo[o-1, 1].X, xLo[o, 0].X - xLo[o-1, 0].X, xLo[o, 1].X - xLo[o-1, 1].X, width = 0.1, head_width = 0.5, length_includes_head = True, color = 'black')
                ...
                ax.arrow(xRo[o-1, 0].X, xRo[o-1, 1].X, xLo[o, 0].X - xRo[o-1, 0].X, xLo[o, 1].X - xRo[o-1, 1].X, width = 0.1, head_width = 0.5, length_includes_head = True, color = 'black')
                ...
                ax.arrow(xLo[o-1, 0].X, xLo[o-1, 1].X, xRo[o, 0].X - xLo[o-1, 0].X, xRo[o, 1].X - xLo[o-1, 1].X, width = 0.1, head_width = 0.5, length_includes_head = True, color = 'black')
                ...
                ax.arrow(xRo[o-1, 0].X, xRo[o-1, 1].X, xRo[o, 0].X - xRo[o-1, 0].X, xRo[o, 1].X - xRo[o-1, 1].X, width = 0.1, head_width = 0.5, length_includes_head = True, color = 'black')
        ...
        ax.arrow(xRo[len(O_index), 0].X, xRo[len(O_index), 1].X, datos.dest[0]-xRo[len(O_index), 0].X, datos.dest[1] - xRo[len(O_index), 1].X, width = 0.1, head_width = 0.5, length_includes_head = True, color = 'black')
        ax.scatter(datos.dest[0], datos.dest[1], s = 10, c = 'black')
