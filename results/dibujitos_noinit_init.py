...
point_cplex_with = point_cplex_with[['Size', 'Instance', 'Capacity', 'GAP', 'NodeCount', 'Runtime', 'ObjVal', 'HeurTime', 'HeurVal']]
# point_cplex['Runtime'] = np.log(point_cplex['Runtime'])
...
polygonal_cplex_with = polygonal_cplex_with[['Size', 'Instance', 'Capacity', 'GAP', 'NodeCount', 'Runtime', 'ObjVal', 'HeurTime', 'HeurVal']]
# point_cplex['Runtime'] = np.log(point_cplex['Runtime'])
