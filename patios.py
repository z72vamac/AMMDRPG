...
data = Data(data, graphs_number=6, grid_mode=True, time_limit=60, alpha=False, fleet_size time_endurance=0.123672786,
...
#             data = Data(data, m=6, grid = True, time_limit=1, alpha = False, fleet_sizen, time_endurance = cap,
#                         initialization=False,
#                         show=True,
